	...
	{	
		...
		if(htmlFile.equals("header.html"))
		{
			if(session.getAttribute("CartDetail")!= null)
			{
				...
				HashMap<String, List<Object>> cartItem = c.getAllItems();
				cartItems=cartItem.size();
			}
			if(session.getAttribute("UserDetail") != null)
			{
				UserDetail userDetail=(UserDetail)session.getAttribute("UserDetail");
				sbuild.append(" <li style='float:right;' class='end'><a href='SignoutPage'>Sign Out</a></li><li style='float:right;'><a href='Profile'>Welcome <b>"+userDetail.getFirstName()+"</b></a></li>    <li style='float:right;'><a href='DisplayOrders'>View Orders</a></li> <li style='float:right;'><a href='CartPage'>Cart("+cartItems+")</a></li></ul></nav>" );
			}
			else{
				sbuild.append(" <li><a href='LoginPage'>Login</a></li> <li class='end'><a href='RegisterPage'>Register</a></li> </ul></nav>");
			}
		}
		out.println(s);
