...
public class AddCartPage extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		else if (pageAction!= null && pageAction.equals("View Product Reviews"))
		{
			RequestDispatcher dis = request.getRequestDispatcher("DisplayReviews");
			dis.forward(request,response);
			return;
		}
		else if (pageAction!= null && pageAction.equals("Write New Reviews"))
		{
		...
		else
		{
			...
			//SaxParser sax= new SaxParser("C:\\apache-tomcat-7.0.34\\webapps\\Assignment_kp\\WEB-INF\\classes\\ProductCatalog.xml");
