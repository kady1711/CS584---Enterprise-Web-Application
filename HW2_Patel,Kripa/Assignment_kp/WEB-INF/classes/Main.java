		...
		for(Map.Entry<String, Object> e : products.entrySet())
		{
			...
			if(category.equals("fwatches")){
				...
				for(FitnessWatch fwatch : fwatches){
					dbInstance.addNewProduct(fwatch.getId(),fwatch.getImage(),fwatch.getName(),fwatch.getPrice(),fwatch.getCondition(),fwatch.getCompany(),fwatch.getColor(),fwatch.getDescription(),fwatch.getRetailer(),"fwatches",fwatch.getAccessories());
				}
			}
			else if(category.equals("watches")){
				watches=(ArrayList<SmartWatch>)products.get(category);
				for(SmartWatch watch : watches){
					dbInstance.addNewProduct(watch.getId(),watch.getImage(),watch.getName(),watch.getPrice(),watch.getCondition(),watch.getCompany(),watch.getColor(),watch.getDescription(),watch.getRetailer(),"watches",watch.getAccessories());
				}
			}
			else if(category.equals("laptops")){
				laptops=(ArrayList<Laptop>)products.get(category);
				for(Laptop laptop : laptops){
					dbInstance.addNewProduct(laptop.getId(),laptop.getImage(),laptop.getName(),laptop.getPrice(),laptop.getCondition(),laptop.getCompany(),laptop.getColor(),laptop.getDescription(),laptop.getRetailer(),"laptops",laptop.getAccessories());
				}
			}
				...
				for(SoundSystem speaker : speakers){
						...
						speaker.getCompany(),speaker.getColor(),speaker.getDescription(),speaker.getRetailer(),"speakers",speaker.getAccessories());
					}
			}
				...
				for(Television television : televisions){
					dbInstance.addNewProduct(television.getId(),television.getImage(),television.getName(),television.getPrice(),television.getCondition(),
						television.getCompany(),television.getColor(),television.getDescription(),television.getRetailer(),"televisions",television.getAccessories());
				}
			}
				...
				for(VoiceAssistant voiceassistant : voiceassistants){
					...
					voiceassistant.getCompany(),voiceassistant.getColor(),voiceassistant.getDescription(),voiceassistant.getRetailer(),"voiceassistants",voiceassistant.getAccessories());
				}
			}
				...
				for(HeadPhone headphone : headphones){
					...
					headphone.getCompany(),headphone.getColor(),headphone.getDescription(),headphone.getRetailer(),"headphones",headphone.getAccessories());
				}
			}
				...
				for(Phone phone : phones){
					...
					phone.getCompany(),phone.getColor(),phone.getDescription(),phone.getRetailer(),"phones",phone.getAccessories());
				}
			}
		}
	}
