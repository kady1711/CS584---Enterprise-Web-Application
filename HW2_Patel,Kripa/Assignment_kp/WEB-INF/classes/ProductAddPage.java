...
public class ProductAddPage extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		SaxParserForAdd s= new SaxParserForAdd(dir+"\\webapps\\Assignment_kp\\WEB-INF\\classes\\ProductCatalog.xml",pname,pprice,pcolor,pcondition,pdescription,pcompany,pimage,pcategory,pSize);
