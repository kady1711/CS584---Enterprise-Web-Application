		...
		{	
			if(category.equals("speakers"))
			{
				...
				for (SoundSystem speaker: speakers) {
					...
					out.println("<input type='hidden' name='pName' value='"+speaker.name+"'>");
					...
					out.println("<tr><td colspan='2' width=\"30%\"><input class=\"button\" type=\"submit\" name=\"action\" style='cursor: pointer;color:white;background-color:red;border:none;padding: 16px 22px;margin: 8px;width: 100%;' value=\"View Product\"></td></tr>");
			...
			if(category.equals("watches"))
			{
				...
				for (SmartWatch watch: watches) {
					...
					out.println("<input type='hidden' name='pCategory' value='"+category+"'>");
					out.println("<input type='hidden' name='pName' value='"+watch.name+"'>");
			...
			if(category.equals("fwatches"))
			{
				...
				for (FitnessWatch fwatch: fwatches) {
					...
					out.println("<input type='hidden' name='pCategory' value='"+category+"'>");
					out.println("<input type='hidden' name='pName' value='"+fwatch.name+"'>");
			...
			if(category.equals("phones"))
			{
				...
				for (Phone phone: phones) {
					...
					out.println("<input type='hidden' name='pCategory' value='"+category+"'>");
					out.println("<input type='hidden' name='pName' value='"+phone.name+"'>");
					...
					out.println("<tr><td colspan='2' width=\"30%\"><input class=\"button\" type=\"submit\" name=\"action\" style=' color: white;background-color: red;border: none;padding: 16px 22px;margin: 8px;width: 100%;cursor: pointer;}' value=\"View Product\"></td></tr>");
					out.println("</form>");out.println("</table></td></tr>");
				}
			}
			...
			if(category.equals("headphones"))
			{
				...
				for (HeadPhone headphone: headphones) {
					...
					out.println("<input type='hidden' name='pCategory' value='"+category+"'>");
					out.println("<input type='hidden' name='pName' value='"+headphone.name+"'>");
					...
					{	
						...
						out.println("<tr><td colspan='2' width=\"30%\"><input class=\"button\" type=\"submit\" name=\"action\" style=' color: white;background-color: red;border: none;padding: 16px 22px;margin: 8px;width: 100%;}' value=\"View Product\"></td></tr>");
						out.println("</form>");out.println("</table></td></tr>");
				}
			}
			...
			if(category.equals("televisions"))
			{
				...
				for (Television television: televisions) {
					...
					out.println("<input type='hidden' name='pCategory' value='"+category+"'>");
					out.println("<input type='hidden' name='pName' value='"+television.name+"'>");
			...
			if(category.equals("voiceassistants"))
			{
				...
				for (VoiceAssistant voiceassistant: voiceassistants) {
					...
					out.println("<input type='hidden' name='pCategory' value='"+category+"'>");
					out.println("<input type='hidden' name='pName' value='"+voiceassistant.name+"'>");
			...
			if(category.equals("laptops"))
			{
				...
				for (Laptop laptop: laptops) {
					...
					out.println("<input type='hidden' name='pCategory' value='"+category+"'>");
					out.println("<input type='hidden' name='pName' value='"+laptop.name+"'>");
					...
					out.println("<tr><td colspan='2' width=\"100%\"><input class=\"button\" type=\"submit\" name=\"action\" style='color: white;background-color: red;border: none;padding: 16px 22px;margin: 8px;width: 100%;}' value=\"View Product\"></td></tr>");
					out.println("</form>");out.println("</table></td></tr>");
				}
			}	
