...
public class ProductAddPage extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		SaxParser s1= new SaxParser(dir+"\\webapps\\Assignment_kp\\WEB-INF\\classes\\ProductCatalog.xml");
		...
		SaxParserForAdd s= new SaxParserForAdd(dir+"\\webapps\\Assignment_kp\\WEB-INF\\classes\\ProductCatalog.xml",pname,pprice,pcolor,pcondition,pdescription,pcompany,pimage,pcategory1,pSize);
