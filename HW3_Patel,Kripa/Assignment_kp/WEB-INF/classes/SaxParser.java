...
public class SaxParser extends DefaultHandler {  
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
		...
		if(element.equalsIgnoreCase("quantity")){
			if(l)
			{
				laptop.setQuantity(Integer.parseInt(eParse));
			}
			if(s)
			{
				speaker.setQuantity(Integer.parseInt(eParse));
			}
			if(v)
			{
				television.setQuantity(Integer.parseInt(eParse));
			}
			if(pt)
			{
				voiceassistant.setQuantity(Integer.parseInt(eParse));
			}
			if(fw)
			{
				fwatch.setQuantity(Integer.parseInt(eParse));
			}
			if(w)
			{
				watch.setQuantity(Integer.parseInt(eParse));
			}
			if(h)
			{
				headphone.setQuantity(Integer.parseInt(eParse));
			}
			if(p)
			{
				phone.setQuantity(Integer.parseInt(eParse));
			}
		...
		if (element.equalsIgnoreCase("onsale")) {
			if(l)
			{
				laptop.setOnSale(eParse);
			}
			if(s)
			{
				speaker.setOnSale(eParse);
			}
			if(v)
			{
				television.setOnSale(eParse);
			}
			if(pt)
			{
				voiceassistant.setOnSale(eParse);
			}
			if(fw)
			{
				fwatch.setOnSale(eParse);
			}
			if(w)
			{
				watch.setOnSale(eParse);
			}
			if(h)
			{
				headphone.setOnSale(eParse);
			}
			if(p)
			{
				phone.setOnSale(eParse);
			}
		...
		if (element.equalsIgnoreCase("rebate")) {
			if(l)
			{
				laptop.setRebate(eParse);
			}
			if(s)
			{
				speaker.setRebate(eParse);
			}
			if(v)
			{
				television.setRebate(eParse);
			}
			if(pt)
			{
				voiceassistant.setRebate(eParse);
			}
			if(fw)
			{
				fwatch.setRebate(eParse);
			}
			if(w)
			{
				watch.setRebate(eParse);
			}
			if(h)
			{
				headphone.setRebate(eParse);
			}
			if(p)
			{
				phone.setRebate(eParse);
			}
