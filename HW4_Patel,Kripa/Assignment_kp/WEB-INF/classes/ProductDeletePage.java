...
public class ProductDeletePage extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		String content="<form action='CheckDeleteProduct' style='border:2px #fff solid ;'>"
		+" <div style='padding:15px;'><h3 style='green' >Product Delete</h3>"
		...
		+"<option value='speakers' selected>Sound System</option><option value='voiceassistances'>Voice Assistant</option><option value='phones'>Phones</option><option value='fwatches'>Fitness Watches</option><option value='laptops'>Laptops</option><option value='televisions'>Television</option><option value='watches'>Smart Watches</option><option value='headphones'>HeadPhones</option></select>"
		+"<button style='color:white;background-color:green;margin:6px;padding:12px 22px;width:100%;cursor:pointer;' type='submit'>Delete Product</button></div></form>";
