...
public class ProductInventoryChart extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		out.println("<article> <h1 align=\"center\"><span style='color:red;'>"+"Inventory Chart</span></h1> ");
		...
		out.println("<div id=\"inventory_barchart\" ></div>");
