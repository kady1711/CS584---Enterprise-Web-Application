...
public class DisplayOrders extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		boolean res = dbInstance.connect();
		if(!res)
		{
			out.println("<div style='color:white; background-color:red;'><h1 style='color:white;background-color:red;'>MySQL Server is not running up!</h1></div>");
		}
