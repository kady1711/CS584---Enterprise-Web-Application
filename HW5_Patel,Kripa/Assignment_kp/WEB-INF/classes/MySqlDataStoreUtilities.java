...
public class MySqlDataStoreUtilities
{
	...
	public boolean connect()
	{
		try{
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/webapp?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","root","Amb!vert6");
