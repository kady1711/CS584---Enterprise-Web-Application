...
{	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		+"<input type='hidden' name='customer' value='add'>"
		+"<label><b>Gender</b></label></br>"
		+"<input type=\"radio\" name=\"usergender\" value=\"female\"> Female<br>"
		+"<input type=\"radio\" name=\"usergender\" value=\"male\" checked> Male<br><br>"
		+"<label><b>Age</b></label>"
		+"<input  placeholder='Enter Age' type='number' name='userage' required><br><br>"	
